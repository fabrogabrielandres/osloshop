...
interface SeedProduct {
  ...
  stockPerType: Partial<Record<ValidSizes, number>>;
  // stockPerType: Partial<{ [key in ValidSizes]: number }>
}
...
export const initialData: SeedData = {
  user: [
    {
      email: "fabrogabrielandres@gmail.com",
      name: "gabriel Fabro",
      password: bcryptjs.hashSync("123456"),
      role: "admin",
    },
    {
      email: "aldanabatalla@gmail.com",
      name: "Aldana Batalla",
      password: bcryptjs.hashSync("123456"),
      role: "user",
    },
